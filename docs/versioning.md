...
|---|---|---|
| App (HAP) | `AppScope/app.json5` | `1.1.1` |
| Native crate | `leantty_ssh/Cargo.toml` | `1.1.1` |
| Core crate | `leantty_ssh/leantty-ssh-core/Cargo.toml` | `1.1.1` |
| OHPM | `entry/oh-package.json5` | `1.1.1` |
| Native OHPM | `entry/src/main/cpp/types/libleantty_ssh/oh-package.json5` | `1.1.1` |
| Root OHPM | `oh-package.json5` | `1.1.1` |
...
package uses `versionCode` `1000000`; the prepared `1.1.1` package uses
`1001001`.
